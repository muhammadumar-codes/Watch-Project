export const watches = [
  {
    ...
    brand: "Rolex",
    description: "Luxury diving watch with 300m water resistance and timeless design.",
    price: 8999,
    discount: 10,
    category: "Female",
    stock: 5,
  ...
  },
  {
    ...
    brand: "Omega",
    description: "The Moonwatch, worn during NASA missions. Legendary chronograph.",
    price: 7599,
    discount: 5,
    category: "Male",
    stock: 3,
  ...
  },
  {
    ...
    brand: "Tag Heuer",
    description: "Racing-inspired chronograph with sporty and stylish design.",
    price: 5499,
    discount: 0,
    category: "Female",
    stock: 7,
  ...
  },
  {
    ...
    name: "Seiko Prospex",
    brand: "Seiko",
    description: "Affordable diving watch with automatic movement and strong durability.",
    price: 699,
    discount: 15,
    category: "Unisex",
    stock: 10,
  ...
  },
  {
    ...
    description: "Iconic luxury watch with octagonal bezel and premium craftsmanship.",
    price: 29999,
    discount: 8,
    category: "Female",
    stock: 2,
